...
const Navbar = () => {
  ...
  return (
    <div className='navbar'>
      ...
      <div className="nav-connect"><a className='anchor-link' href='https://www.linkedin.com/in/neelesh-nainwal-784535201' target='_blank' rel='noopener noreferrer'>Connect with me</a></div>
    </div>
  )
}
